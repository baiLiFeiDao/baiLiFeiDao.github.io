...
comments:
  ...
  lazyload: true
  count: ture # Display comment count in post's top_img
...
valine:
  ...
  appId: Tx3M9MxDZZgBWfUUahtcFI7D-gzGzoHsz
  appKey: DcFpPUNUITMZuw9iUgtbH1g9
  notify: false # valine mail notify (true/false) https://github.com/xCss/Valine/wiki
  verify: false # valine verify code (true/false)
  pageSize: 10 # comment list page size
  avatar: monsterid # gravatar style https://valine.js.org/#/avatar
  lang: zh-cn # i18n: zh-cn/en
  placeholder: 留下你的足迹 # valine comment input placeholder(like: Please leave your footprints )
  guest_info: 昵称,邮箱,链接 #valine comment header info
